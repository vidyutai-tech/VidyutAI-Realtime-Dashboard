...
from app.api.endpoints import auth, sites, assets, data, actions, simulations, optimization
...
api_router.include_router(optimization.router, prefix="", tags=["Source Optimization"])
